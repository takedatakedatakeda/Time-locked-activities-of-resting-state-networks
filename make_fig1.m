...
colorbar
title({'Frequency of selected', 'hyperparameters'})
xlabel('Number of spatiotemporal patterns')
...
ylabel('Probability')
title({'Probability of', 'inter-onset intervals'})
...
xlabel('Inter-onset interval [s]')
ylabel('Probability')
title({'Log-log plot of plobability of', 'inter-onset intervals'})
